...
package org.plazy.utils {
	...
	public class MD5_vk {
		...
		private static function ConvertToWordArray(string:String):* {
		...
		private static function WordToHex(lValue:*):* {
			...
			var WordToHexValue:String = "", WordToHexValue_temp:String = "", lByte:*, lCount:*;
		...
		private static function Utf8Encode(string:String):* {
